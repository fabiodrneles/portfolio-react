          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                Enhancing user experiences through meticulous and stylized
                interface development. Translating visionary designs into
                elegant code, creating visually appealing and highly functional
              ...
              <ul className="services__modal-services grid">
                ...
                <li className="services__modal-service">
                  <i className="uil uil-check-circle services__modal-icon"></i>
                  <p className="services__modal-info">
                    Provide a seamless and enjoyable browsing experience across
                    devices.
                  </p>
                </li>
        ...
        <div className="services__content">
          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                Powering user experiences through efficient and flexible backend
                solutions. I transform intricate ideas into functional and
                secure server-side implementations, ensuring high-quality
